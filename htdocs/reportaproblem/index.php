...
<script>
  ...
  gtag('config', 'G-ECSR2KJCK2');
    ...
    <meta name="description" content="ClimaCast brings accurate weather forecasts and safety information directly from our site.">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2181826692506424"
...
@media screen and (max-width: 480px) {
    ...
    .art-1 h1 {
        font-size: 20px; /* Further adjust subtitle size */
    }
...
<body>
    <header>
        <a class="nav-bar-btn" onclick="window.history.back()"">Back</a>
    </header>
    
    <div class="main-web-content">
        <h1 id="title">Report a Problem</h1>
        
        <h3>You can report an issue to ClimaCast if you feel what you've found is broken or a security risk.</h3>

        <div class="art-1">
            <div>
                <h1>Ready to fill out the form?</h1>
                <p>It shouldn't take longer than 10 minutes and by doing so, you're helping to improve ClimaCast.</p>
            </div>
            <a href="https://forms.gle/UfwepQBa2R4TuAKr6">Go There</a>
        </div>
    </div>
</body>
</html>
